    ...
    void shouldGetWeatherData() {
        ...
        assertAll("CityWeatherDto list",
                ...
                () -> result.forEach(cityWeatherDto -> {
                    ...
                    assertTrue(cityWeatherDto.getTemperature() >= -5 && cityWeatherDto.getTemperature() <= 100, "Temperature should be between -5 and 100");
                    assertTrue(cityWeatherDto.getWindSpeed() >= -10 && cityWeatherDto.getWindSpeed() <= 100, "Wind speed should be between -10 and 100");
                })
        );
    }
}